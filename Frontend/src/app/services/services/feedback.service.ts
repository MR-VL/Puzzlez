...
export class FeedbackService extends BaseService {
  ...
  /** Path part for operation `findAllFeedbacksByPuzzle()` */
  static readonly FindAllFeedbacksByPuzzlePath = '/feedbacks/puzzle/{puzzle-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `findAllFeedbacksByPuzzle()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllFeedbacksByPuzzle$Response(params: FindAllFeedbacksByPuzzle$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseFeedbackResponse>> {
    return findAllFeedbacksByPuzzle(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `findAllFeedbacksByPuzzle$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllFeedbacksByPuzzle(params: FindAllFeedbacksByPuzzle$Params, context?: HttpContext): Observable<PageResponseFeedbackResponse> {
    return this.findAllFeedbacksByPuzzle$Response(params, context).pipe(
